            ...
            <div class="row ">
                <div class="col-lg-4 text-center p-4 border-top">
                    ...
                    <h5>Digital infrastructure with IBM 
                        ...
                        energy efficiency and manage grid
                        reliability</h5>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
                <div class="text-center mx-auto  section-main-title">
                    ...
                    <p class="text-muted mx-auto mt-2">If you would prefer a Savtrik demo before you purchase,
                        just contact us or visit link below. We will show you how
                        Savtrik works and answer any questions you have. Please fill out the form below for a demo
                        and
                ...
                <div class="col-lg-4">
                    <div class="text-center mt-4">
                        ...
                        <div class="mt-2">
                            ...
                            <p class="text-muted">+62 895320504567</p>
                        </div>
                    </div>
                    <div class="text-center mt-4">
                        <div>
                        ...
                        <div class="mt-2">
                            ...
                            <p class="text-muted">contact@savtrik.com</p>
                        </div>
                    </div>
                    <div class="text-center mt-4">
                        <div>
                        ...
                        <div class="mt-2">
                            ...
                            <p class="text-muted">Jl. Haji Juhri No. 40, Meruya Selatan, Jakarta Barat, DKI Jakarta</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
            ...
            <div class="row pt-4 pb-4">
                <div class="col-lg-12">
                    <div class="float-left float_none mt-2 mb-2">
                        <p class="copy-rights text-muted mb-0">2019 &copy; Savtrik</p>
                    </div>
